                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Modifier_categorie</h5>
                                            <p class="m-b-0">Permet d'Modfier des categories</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                                ...
                                                <div class="card">
		                                            ...
		                                            ?>
                                                        ...
                                                        <div class="form-group form-default">
                                                                <input type="number"  id="id_categorie" name="id_categorie" class="form-control" value="<?php echo $categorie['id_categorie']; ?>" required="" onclick="return saisirID()">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text"  id="nom" name="nom" class="form-control" value="<?php echo $categorie['nom']; ?>" required="" onclick="return saisirNom()">
                                                                <span class="form-bar"></span>
