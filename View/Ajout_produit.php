<?php
    include_once 'C:/xamppp/htdocs/anwar_projet/Model/produit.php';
    include_once 'C:/xamppp/htdocs/anwar_projet/Controller/produitC.php';
    include_once 'C:/xamppp/htdocs/anwar_projet/Model/categorie.php';
    include_once 'C:/xamppp/htdocs/anwar_projet/Controller/categorieC.php';
                                            ...
                                            <div class="col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="form-group form-default">
                                                                <input type="number" name="id_produit" id="id_produit"   class="form-control" required="" onclick="return saisirID()">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="number" id="prix_produit" name="prix_produit" class="form-control" required="" onclick="return saisirprix()">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Prix</label>
                                                                <p id="errorPRIX" class="error"></p>
                                                            </div>
                                                            <div class="form-group form-default">
                                                                <input type="number"  id="quantite_produit" name="quantite_produit"  class="form-control"required="" onclick="return saisirQuantite()">
                                                                <span class="form-bar"></span>
