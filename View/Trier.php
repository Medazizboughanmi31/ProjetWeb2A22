                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        <h5 class="m-b-10">Gestion produit</h5>
                                        <p class="m-b-0">It is a management that allows to take charge of events and produit.</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="page-body">
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h5>Gestion produit</h5>
                                            <span>It is a management that allows to take charge of produit</span>
                                        ...
                                        <div class="card-block">
                                            <p>
                                                ...
                                                "produit type control center."
                                            </p>
                                            <a href="Ajout_produit.php" class="" name="ajouter">Add</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-block table-border-style">
                                            ...
                                            <?php
$bdd= new PDO('mysql:host=localhost;dbname=projet_anwarr;charset=utf8','root','');
...
<?php if($produit->rowCount() > 0) { ?>
    ...
    <?php while($a=$produit->fetch()){ ?>
        ...
        <tr>
				...
				<td> 
                <button class="btn btn-primary"><a href="Modifier_produit.php?id_produit=<?php echo $a['id_produit']; ?>">Edit</a>  </button>
                <button class="btn-danger btn"><a href="Supprimer_produit.php?id_produit=<?php echo $a['id_produit']; ?>">Delete</a>  </button>
