                                    ...
                                    <form action="#">
                                        <div class="form-group">
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control"  name="nom_produit" placeholder='Search By Name' onfocus="this.placeholder = ''" onblur="this.placeholder = 'Search By Name'">
                                ...
                                <aside class="single_sidebar_widget post_category_widget">
                                    ...
                                    <ul class="list cat-list">
                                        <li class="sidenav">
                                            ...
                                            <a href="Trier.php"><p>Ascending</p></a>
                                            </div>
                                        </li>
                                        <li>
