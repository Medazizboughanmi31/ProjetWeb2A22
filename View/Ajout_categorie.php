                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-8">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Ajout_categorie</h5>
                                            <p class="m-b-0">Permet d'ajouter des categories</p>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card">
                                                    ...
                                                    <div class="form-group form-default">
                                                                <input type="number" name="id_categorie" id="id_categorie"   class="form-control" required="" onclick="return saisirID()">
                                                                <span class="form-bar"></span>
                                                            ...
                                                            <div class="form-group form-default">
                                                                <input type="text"  id="nom" name="nom"  class="form-control"required="" onclick="return saisirNom()">
                                                                <span class="form-bar"></span>
                                                                <label class="float-label">Nom</label>
                                                                <p id="errorName" class="error"></p>
                                                            </div>
                                                            <input type="submit" onclick="ajout(event)" value="Add">
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
...
<script type="text/javascript" src="assets/js/script.js"></script>
 ...
 <script> 
    ...
    function saisirID(){
                var name = document.getElementById('id_categorie').value;
                var regex = /^[0-9]+$/;
