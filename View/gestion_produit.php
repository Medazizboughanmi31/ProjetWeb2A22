...
<div id="pcoded" class="pcoded">
    ...
    <div class="pcoded-container navbar-wrapper">
                    ...
                    <div class="pcoded-inner-navbar main-menu">
                        ...
                        <ul class="pcoded-item pcoded-left-item">
                            ...
                            <li class="pcoded-hasmenu active pcoded-trigger">
                                <a href="javascript:void(0)" class="waves-effect waves-dark">
                                    <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                                    <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Gestions des produits</span>
                                    <span class="pcoded-mcaret"></span>
                                </a>
                                <ul class="pcoded-submenu">
                                    <li class=" ">
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-8">
                                    <div class="page-header-title">
                                        ...
                                        <p class="m-b-0">It is a management that allows to take charge of produit and produit.</p>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                        ...
                                        <div class="card-block table-border-style">
                                            ...
                                            <div class="p-15 p-b-0">
                                                        <form class="form-material" action = "recherche.php" method ="get">
                                                            <div class="form-group form-primary">
                                                                ...
                                                                <span class="form-bar"></span>
                                                                <label class="float-label"><i class="fa fa-search m-r-10"></i>Search produit</label>
                                                                </div>
                                                                </div>
                                           ...
                                           <?php
                                            ...
                                            <div class="table-responsive">
                                                <table id ="user1" class="table table-hover" style="font-size:medium;">
                                                 <thead>
                                                        <tr>
                                                            <td> ID</td>
                                                            <td>NOM</td>
                                                 ...
                                                 <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td data-label="Name"><?php echo'<img src="assets/images/'.$produit['image_produit'].'"width="100;" height="100" alt="Image">'  ?></td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <form method="POST" action="Modifier_produit.php">
                                                                    <button class="btn btn-warning waves-effect waves-light" type="submit" name="Modifier" value="Modifier"> <span class="glyphicon glyphicon-pencil"></span> </button>
                                                                    <input type="hidden" value=<?PHP echo $produit['id_produit']; ?> name="id_produit">
                                                                </form>
                                                            </td>
                                                            <td>
                                                                <a  href="Supprimer_produit.php?id_produit=<?php echo $produit['id_produit']; ?>">  <button class="btn btn-danger waves-effect waves-light" type="submit" value="Supprimer"><span class="glyphicon glyphicon-trash"></span></button> </a>
        ...
        for($i=1;$i<=$pagesTotales;$i++){
            ...
            echo '<a href="gestion_produit.php?page='.$i.'">'.$i.'</a> ';
        }
    }
