    ...
    if (
        ...
        if (
          !empty($_POST["objet"]) && 
            ...
            header('Location:envoyer_des_mails.php?id_rec='.$_POST['objet']);
        }
        else
...
.btn {
    ...
    background-image: linear-gradient(100deg, #3ab5db 0%, #690483 100%);
                                        ...
                                        <nav>
                                            <ul id="navigation">
                                                ...
                                                <ul class="submenu">
                                                    ...
                                                    </ul></li><li><a href="adoptioncenter.html">Product</a>
                                                    <ul class="submenu">
    ...
    <main>
        ...
        <div class="slider-area position-relative">
            ...
            <table align="center">
                ...
                <tr data-animation="fadeInUp" data-delay=".6s">
                    <td>
                        <label for="date" style="color:white;">Date de réclamation:   
                        </label>
                    </td>
                    <td>
                       <h2 id ="date"style="color:white;"><center>    <?php echo date("Y/m/d") ;?></center>
                        </h2>
                    </td>
                </tr>  
                <tr data-animation="fadeInUp" data-delay=".6s">
          ...
          <input type="text" name="etat" id="etat" value="0">
                    ...
                    <td>
                   <a class="hero-btn mb-10" href="afficherlistereclamations.php" data-animation="fadeInUp" data-delay=".8s">liste des <br>reclamations<span class="glyphicon glyphicon-circle-arrow-right" style="position: absolute; top:35%;right:1%;"></span></a>
                    </td>
                </tr>
            </table>
        </form>
