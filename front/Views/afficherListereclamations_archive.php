...
require_once( '../Controller/reclamationC.php');
  ...
  $messageC=new messageC();
	$listereclamations=$reclamationC->afficherreclamations(15,1); 
?>
<html>
<html>
    <head>
...
<div class="masque">
<div class="box">
    <h1 style="color:white;font-size:50px;">Archive:</h1>
<dl>
<?php $i=0;
...
<?php
                ...
                if($i==0){
                    echo '<script language="javascript">swal({
                        ...
                        text: "Aucune reclamation dans l\'archive!",
                        icon: "error",
                      });</script><h1 style="color:white;font-size:100px;opacity:0.5;">Aucune reclamation dans l\'archive</h1>';
                }
			?>
 </dl>
