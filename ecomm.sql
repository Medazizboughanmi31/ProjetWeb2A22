...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2913889765ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Tables récentes" class="drop_button btn">Récentes</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecomm&table=commande">`ecomm`.`commande`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecomm&table=product">`ecomm`.`product`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=ecomm&table=cart">`ecomm`.`cart`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=techplus&table=root">`techplus`.`root`</a></li></ul></div><div class="drop_list"><button title="Tables préférées" class="drop_button btn">Préférées</button><ul id="pma_favorite_list"><li class="warp_link">Pas de tables préférées.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6741346e2c2c343471424b4673486d51">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Daté du
                            ...
                            targetdb="techplus" targettable="root">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `root`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="snft" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
...
$dsn = &#039;mysql:host=localhost;dbname=zaalouni&#039;;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="zaalouni" targettable="">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide"
                            targetdb="ecomm" targettable="cart">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `ecomm`.`cart` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `id_p` INT(11) NOT NULL ,  `id_u` INT(11) NOT NULL ,  `id_c` INT(11) NOT NULL ,  `quantity` INT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ecomm" targettable="commande">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `ecomm`.`commande` ( `id` INT(11) NOT NULL AUTO_INCREMENT ,  `is_u` INT NOT NULL ,  `quantity` INT NOT NULL ,  `price` INT NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="ecomm" targettable="product">
                            <div class="action_content">
                    <span class="action collapse">
            Réduire
                    </span>
            ...
            Daté du
                            ...
                            <span class="query">CREATE TABLE `ecomm`.`product` ( `id` INT NOT NULL AUTO_INCREMENT ,  `nom` VARCHAR(30) NOT NULL ,  `prix` INT(11) NOT NULL ,  `quantite` INT(11) NOT NULL ,  `img` BLOB NOT NULL ,    PRIMARY KEY  (`id`)) ENGINE = InnoDB;</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecomm" targettable="commande">
                            <div class="action_content">
            ...
            Daté du
                            ...
                            <span class="query">SELECT * FROM `commande`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="ecomm" targettable="commande">
                            <div class="action_content">
