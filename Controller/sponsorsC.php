<?php
	include 'D:/xampp/htdocs/G.Events/config3.php';
	include_once 'D:/xampp/htdocs/G.Events/Model/sponsors.php';
	class sponsorsC {
		...
		function ajoutersponsors($sponsors){
			$sql="INSERT INTO sponsors (id_sp,name_sp,type_sp,numtel_sp,mail_sp,inves_sp,image_sp,descrip_sp,id2_ev) 
			VALUES (:id_sp,:name_sp,:type_sp,:numtel_sp,:mail_sp,:inves_sp,:image_sp,:descrip_sp,:id2_ev)";
			$db = config3::getConnexion();
			try{
